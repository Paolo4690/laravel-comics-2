...
<footer>
    <div class="footer-top">
        <div class="container">
            <div class="info">
                <p>All Site Content TM and © 2020 DC Entertainment, unless otherwise <span class="text-blu">noted here</span>. All rights reserved.
                    <span class="text-blu">Cookies Settings</span>
                </p>
            </div>
